  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li>
          <a href="{{ route('master')}}" class="nav-link px-2 link-secondary">
            Home
          </a>
        </li>
        <li>
          <a href="{{ route('category', ['category' => 'genti'])}}" class="nav-link px-2 link-dark">
            Genti
          </a>
        </li>
        <li>
          <a href="{{ route('category', ['category' => 'rucsacuri'])}}" class="nav-link px-2 link-dark">
            Rucsacuri
          </a>
        </li>
        <li>
          <a href="{{ route('category', ['category' => 'portofele'])}}" class="nav-link px-2 link-dark">
            Portofele
          </a>
        </li>
        <li>
